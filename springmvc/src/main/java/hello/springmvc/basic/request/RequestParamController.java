...
public class RequestParamController {
    ...
    public String requestParamV2(@RequestParam("username")String userName, @RequestParam("age")int userAge) throws IOException {
    ...
    public String requestParamRequired(@RequestParam(required=false)String username,int age) throws IOException {
        log.info("username:{}, age:{}", username, age);
        return "ok";
    }
